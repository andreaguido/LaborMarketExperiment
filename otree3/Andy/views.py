...
class beliefelicitation(Page):
    def is_displayed(self):
        return (self.round_number == 8 or self.round_number == 13) and self.player.type == 'principal'
...
class beliefelicitationPOSITIVE(Page):
    def is_displayed(self):
        return (self.round_number == 14 or self.round_number == 18) and self.player.type == 'principal' and self.subsession.draw ==1
    form_model= models.Player
...
class strategymethod(Page):
    def is_displayed(self):
        return (self.round_number == 8 or self.round_number == 13) and self.player.type == 'agent'
    form_model= models.Player
...
class strategymethodPOSITIVE(Page):
    def is_displayed(self):
        return (self.round_number == 14 or self.round_number == 18) and self.player.type == 'agent' and self.subsession.draw ==1
    form_model= models.Player
    ...
    def vars_for_template(self):
        return{
            'num_round' : self.subsession.round_number,
            'pre_eleffort_13_1': self.player.in_round(13).steffort1,  # to be displayed in round 14
            ...
            'pre_eleffort_14_1': self.player.in_round(14).steffort1,  # to be displayed in round 18
...
class strategymethodNEGATIVE(Page):
    def is_displayed(self):
        return (self.round_number == 14 or self.round_number == 18) and self.player.type == 'agent' and self.subsession.draw ==0
    form_model= models.Player
...
class finalquestionnaire(Page):
    form_model = models.Player
    form_fields = ['gender', 'undergrad', 'comments']
    def is_displayed(self):
        return self.round_number == Constants.num_rounds
